dojo.provide("djeo.util.proj4js");
/*
...
var proj4js = djeo.util.proj4js;

proj4js.transform = function(source, dest, point) {
	return Proj4js.transform(source, dest, point);
}

proj4js.addDef = function(defName, def) {
	Proj4js.defs[defName] = def;
}

proj4js.addProj = function(projName, proj) {
	Proj4js.Proj[projName] = proj;
}

proj4js._getProj4js = function() {
	return Proj4js;
}
 ...
 */
dojo.declare("djeo.util.proj4js.Proj", null, {
	...
	*/
	...
	initTransforms: function() {
		dojo.mixin(this, Proj4js.Proj[this.projName]);
		this.init();
	},
	...
	deriveConstants: function() {
		...
		this.datum = djeo.util.proj4js.Datum(this);
	}
});
...
/** datum object
*/
dojo.declare("djeo.util.proj4js.Datum", null, {

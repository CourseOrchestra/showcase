...
//		expand: function (target, expand, noTransition) {
		expand: function (target, expand, noTransition, kursLevelUpdate) {
// [KURS
...
// [KURS					
			if(target && target.data && ((target.data.hasChildren == "0") || (target.data.hasChildren == "false"))){
				return;
			}
// KURS]
...
//			if (target && target.mayHaveChildren && (noTransition || expand !== isExpanded)) {
			if (kursLevelUpdate || (target && target.mayHaveChildren && (noTransition || expand !== isExpanded))) {				
// KURS]				

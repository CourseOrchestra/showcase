 ...
 * app.properties содержит кириллический символ.
 * 
 */
public class GeneralAppPropsValueContainsCyrillicSymbolException extends BaseException {
	...
	private static final String ERROR_MES =
		"Общий файл app.properties содержит параметр %s, в значении которого (%s) присутствует кириллический символ.";

	public GeneralAppPropsValueContainsCyrillicSymbolException(final String param, final String value) {

...
public class Accordeon {
	...
	public void refreshAccordeon(final ID selectionId, final boolean fireEventSelection) {
		...
		final ID idToSelect = (accordeon.getVisibleIndex() > -1) && (uiListOfAccordeonTrees
				.get(accordeon.getVisibleIndex()).getSelectedItem() != null)
						? ((NavigatorElement) uiListOfAccordeonTrees
								.get(accordeon.getVisibleIndex()).getSelectedItem()
								.getUserObject()).getId()
						: new ID("");

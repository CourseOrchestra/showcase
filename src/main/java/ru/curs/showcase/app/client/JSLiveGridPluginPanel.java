...
public class JSLiveGridPluginPanel extends JSBaseGridPluginPanel {
	...
	private static native void setCallbackJSNIFunction() /*-{
															...
															$wnd.gwtProcessFileDownload = @ru.curs.showcase.app.client.api.JSLiveGridPluginPanelCallbacksEvents::pluginProcessFileDownload(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;);
	...
	public JSLiveGridPluginPanel(final DataPanelElementInfo element) {
		...
		this.getPanel().addStyleName("jslivegrid-element");
	...
	protected native void runGrid(final String procName,
		...
		try {
			...
			$wnd.safeIncludeJS("js/ui/grids/liveDGrid.js");
			$wnd.eval(procName + "(" + params + ");");
		}
	...
	protected void resetGridSettingsToCurrent() {
		...
		localContext.setSubtype(DataPanelElementSubType.JS_LIVE_GRID);

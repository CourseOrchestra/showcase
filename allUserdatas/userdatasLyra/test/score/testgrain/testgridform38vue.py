...
class TestGridForm38vue(GridForm):  
    def __init__(self, context):
        super(TestGridForm38vue, self).__init__(context)
    ...
    def _getCursor(self, context):
        ...
        self.getFormProperties().setHeader(u'''<h2 class="testStyle">Видимость столбцов, Порядок столбцов, Информация о столбцах</h2>''')

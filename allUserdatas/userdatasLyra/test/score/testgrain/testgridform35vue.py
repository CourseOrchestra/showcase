...
class TestGridForm35vue(GridForm):  
    def __init__(self, context):
        super(TestGridForm35vue, self).__init__(context)
    ...
    def _getCursor(self, context):
        ...
        self.getFormProperties().setHeader(u'''<h2 class="testStyle">Задание css для строки грида, Выделение ячейки</h2>''')
